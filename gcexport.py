...
def gc_sync(username, password, count, format, directory, unzip=True):
	...
	while total_downloaded < total_to_download:
		...
		for a in activities:
			...
			if isfile(data_filename):
				...
				continue
			if format == 'original' and isfile(fit_filename):  # Regardless of unzip setting, don't redownload if the ZIP or FIT file exists.
			...
			try:
				...
				if e.code == 500 and format == 'tcx':
					...
					data = ''
				elif e.code == 404 and format == 'original':
